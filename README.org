...
* Dependencies
  ...
  At the moment, the code is almost but not quite portable and can only be used with the [[sbcl][SBCL]] implementation of Common Lisp.

  Dependencies not available via [[quicklisp][Quicklisp]]:
